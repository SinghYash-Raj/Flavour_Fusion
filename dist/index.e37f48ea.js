...
const showRecipe = async function() {
    try {
        ...
        (0, _resultViewJsDefault.default).update(_modelJs.getSearchReasultPage());
...
const ControlSearchResult = async function() {
    try {
        ...
        (0, _resultViewJsDefault.default).render(_modelJs.getSearchReasultPage());
...
const controlPagination = function(GoToPage) {
    ...
    (0, _resultViewJsDefault.default).render(_modelJs.getSearchReasultPage(GoToPage));
...
},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime":"dXNgZ","./model.js":"Y4A21","./views/RecipeView.js":"aFEMw","url:../img/icons.svg":"loVOp","./views/SearchView.js":"c7Rpf","./views/ResultView.js":"8cMC5","./views/PaginationView.js":"9Uw3J","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/BookMarksView.js":"4agqx","./config.js":"k5Hzs","./views/addRecipeView.js":"i6DNj"}],"49tUX":[function(require,module,exports) {
...
const LoadSearchRecipe = async function(query) {
    try {
...
const getSearchReasultPage = function(page = state.search.page) {
...
const API_KEY = "7a505043-0782-47a9-8815-d85974ed9fcc";
...
const AJAX = async function(url, uploadData) {
    try {
        ...
        if (!res.ok) throw new Error(`${data.msg}  (${res.status})`);
        return data;
    } catch (err) {
        throw err;
    }
...
},{"regenerator-runtime":"dXNgZ","./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aFEMw":[function(require,module,exports) {
...
class recipeview extends (0, _viewDefault.default) {
    ...
    _errorMessage = "We could not find the recipe.Plz try another one!";
    _SuccessMessage = "";
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./PreviewView":"lwi5y"}],"lwi5y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Uw3J":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        const NoOfPage = Math.ceil(this._data.results.length / this._data.resultPerPage);
        // Page 1, and there are other pages also
        if (curPage === 1 && NoOfPage > 1) return ` <button data-goto = "${curPage + 1}" class="btn--inline pagination__btn--next">
      ...
      <svg class="search__icon">
        ...
        // Last Page
        if (curPage === NoOfPage && NoOfPage > 1) return `<button data-goto = "${curPage - 1}" class="btn--inline pagination__btn--prev">
      <svg class="search__icon">
      ...
      <span>Page ${curPage - 1}</span>
        ...
        if (curPage !== 1 && curPage < NoOfPage) return `<button data-goto = "${curPage - 1}" class="btn--inline pagination__btn--prev">
        <svg class="search__icon">
          <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
        </svg>
        <span>Page ${curPage - 1}</span>
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4agqx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _previewView = require("./PreviewView");
var _previewViewDefault = parcelHelpers.interopDefault(_previewView);
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./PreviewView":"lwi5y"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire3a11")
